...
class Commands {
    ...
    public Commands() {
        ...
        instructionList.add("left - rotates the robot left at the current set angle.");
        instructionList.add("right - rotates the robot right at the current set angle.");
    ...
    public void left () {
        System.out.println("left 1 " + degreesToTurn);//test
            degreesToTurn += moveToLocation.turnLeft(degreesToTurn);
            
            System.out.println("left 2 " + degreesToTurn);//test
  
     
    }
    
    public void right(){
        System.out.println("right 1 " + degreesToTurn);//test
            degreesToTurn = moveToLocation.turnRight(degreesToTurn);
            
            System.out.println("right 2 " + degreesToTurn);//test
        }
    public void forward(){
